...
public class TestData {
	...
	public static List<News> getAllNews() {
		...
		newsList.add(new News(2, "Ivan", "Bipin", "Good budget description budget"));
		...
		newsList.add(new News(3, "Sara", "Daji", "Good budget"));
		return newsList;
	}
	...
	public static List<Transaction> getAllTransactions() {
		...
		transactions.add(new Transaction(new Trader("Yog", "Mumbai"), 2011, 93000));
