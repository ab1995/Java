...
public class ChatApplication {
	...
	public static void sendMessage(){
		...
		if(currUser!=null){
			...
			int cnt=0;
			for(Map.Entry m:chatRooms.entrySet()){
				Set<String> set=chatRooms.get(m.getKey());
				if(set.contains(currUser))
				{
					System.out.println(m.getKey());  
					cnt++;
				}
			...
			if(cnt>0)
			{
				...
				System.out.println("You are not member of any ChatRoom");
			}
	...
	public static void displayMessagesFromChatRooms(){
		...
		if(currUser!=null){
			...
			ArrayList<Message> msgList=chatRoomMessages.get(selectedChatRoom);
			System.out.println("Messages for "+selectedChatRoom);
	...
	public static void main(String[] args) {
		...
		do{
			...
			case 4: sendMessage();
				break;
			case 5: displayMessagesFromChatRooms();
				break;
